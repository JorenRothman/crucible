                ...
                <div className="max-w-3xl w-full text-center space-y-12">
                    <div className="space-y-6">
                        ...
                        <p className="text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed">
                            Production-ready Next.js starter with auth, database, and UI components
                            built-in. Focus on your project, not the boilerplate.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-12 border-t border-border/50">
                        ...
                        <div className="space-y-2 text-center sm:text-left">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Enterprise-grade auth with Better Auth. OWASP-compliant out of the
                                box.
                            </p>
                        </div>
                        <div className="space-y-2 text-center sm:text-left">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Drizzle ORM, PostgreSQL, and a bulletproof architecture that grows
                                with you.
                            </p>
                        </div>
                    </div>
